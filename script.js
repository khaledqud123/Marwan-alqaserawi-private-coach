...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /*
     * iPhone / slow-media safety fallback.
     * The page must never remain stuck on the loader
     * just because the video takes too long to load.
     */
    ...
    function initializeHeroVideo() {
        ...
        /* -------------------------------------------------
           Force mobile-safe video attributes
           ------------------------------------------------- */
        ...
        /* -------------------------------------------------
           Show fallback ONLY if video genuinely fails
           ------------------------------------------------- */
        ...
        const attemptPlay = () => {
            ...
            try {
                ...
                if (
                    ...
                    promise
                        ...
                        .catch(() => {
                             ...
                             * temporarily on iPhone.
                             *
                             * Do not show fallback.
                             */
                ...
                /*
                 * Ignore temporary autoplay blocks.
                 */
        ...
        /* -------------------------------------------------
           Retry after mobile interaction
           ------------------------------------------------- */
